                    ...
                    (function (ColumnsManagers) {
                        var FilterMenu = /** @class */ (function () {
                            ...
                            FilterMenu.prototype.createSectionElementTypeSelect = function (section, operator, value) {
                                ...
                                var allServerTypesControlTypesOrders = ColumnsManagers.FilterOperatorsCfg.SERVER_TYPES_CONTROL_TYPES_ORDERS;
                                ...
                                try {
                                    for (var allControlTypes_1 = __values(allControlTypes), allControlTypes_1_1 = allControlTypes_1.next(); !allControlTypes_1_1.done; allControlTypes_1_1 = allControlTypes_1.next()) {
                                        ...
                                        if ((allowedControlTypes & controlType) != 0) {
                                            ...
                                            option.title = [
                                                'column',
                                                ColumnsManagers.FilterOperatorsCfg.CONTROL_TYPES_OPERATORS.get(controlType).toString(),
                                                ColumnsManagers.FilterOperatorsCfg.CONTROL_TYPES_VALUE_PATTERNS.get(controlType).replace('<value>', 'value')
                                            ].join(' ');
                                            option.innerHTML = this.translator.Translate(ColumnsManagers.FilterOperatorsCfg.CONTROL_TYPES_TEXTS.get(controlType));
                            ...
                            FilterMenu.prototype.createSectionElementValueInput = function (section, operator, value, currentControlType) {
                                ...
                                if (currentControlType === AgGrids.Enums.FilterControlType.IS_NULL ||
                                    ...
                                    if (value != null) {
                                        var valuePattern = ColumnsManagers.FilterOperatorsCfg.CONTROL_TYPES_VALUE_PATTERNS.get(currentControlType), regExp = new RegExp('^' + valuePattern.replace('<value>', '(.*)') + '$', 'g'), value = value.replace(regExp, '$1');
                            ...
                            FilterMenu.prototype.getFilteringFromControls = function () {
                                ...
                                try {
                                    for (var _b = __values(this.elms.sections), _c = _b.next(); !_c.done; _c = _b.next()) {
                                        ...
                                        valuePattern = ColumnsManagers.FilterOperatorsCfg.CONTROL_TYPES_VALUE_PATTERNS.get(filteringControlType);
                                        value = valuePattern.replace('<value>', rawValue);
                                        operator = ColumnsManagers.FilterOperatorsCfg.CONTROL_TYPES_OPERATORS.get(filteringControlType);
