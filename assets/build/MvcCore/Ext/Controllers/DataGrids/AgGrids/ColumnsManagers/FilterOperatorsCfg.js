                    ...
                    (function (ColumnsManagers) {
                        ...
                        var FilterOperatorsCfg = /** @class */ (function () {
                            ...
                            FilterOperatorsCfg.SERVER_TYPES_EXTENDED_FILTER_MENUS = new Map([
                                [AgGrids.Enums.ServerType.STRING, ColumnsManagers.FilterMenu],
                                [AgGrids.Enums.ServerType.BOOL, ColumnsManagers.FilterMenu],
                                [AgGrids.Enums.ServerType.INT, ColumnsManagers.FilterMenus.Int],
                                [AgGrids.Enums.ServerType.FLOAT, ColumnsManagers.FilterMenus.Float],
                                [AgGrids.Enums.ServerType.MONEY, ColumnsManagers.FilterMenus.Money],
                                [AgGrids.Enums.ServerType.DATE, ColumnsManagers.FilterMenus.Date],
                                [AgGrids.Enums.ServerType.DATE_TIME, ColumnsManagers.FilterMenus.DateTime],
                                [AgGrids.Enums.ServerType.TIME, ColumnsManagers.FilterMenus.Time],
                            ]);
